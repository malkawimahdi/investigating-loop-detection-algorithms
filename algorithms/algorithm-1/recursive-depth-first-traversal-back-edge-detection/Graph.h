...
private:
    ...
    bool recursiveDepthFirstSearchSingleNode(int &node); // Implementation of Depth First Search (DFS) from a given node.
...
public:
    ...
    bool recursiveDepthFirstSearch(void);                          // Initialising function to detect back edge loops.
};
